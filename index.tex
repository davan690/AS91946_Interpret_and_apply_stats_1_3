...
\tightlist
\item
  \textbf{AS1.1 (Internal)} - statistical investigation in context
\item
  \textbf{AS1.3 (External / 91946)} - interpret and apply mathematical
  and statistical information in context
\end{itemize}

The aim is to make the shared learning explicit, avoid duplication, and
show students exactly where each idea is assessed.

\section{Overlap and difference (first-page
map)}\label{overlap-and-difference-first-page-map}
...
\bottomrule\noalign{}
\endlastfoot
Statistical enquiry cycle (PPDAC) & Core assessed process & Used for
interpretation and critique & \textbf{Both} \\
Designing and carrying out an investigation & Strong focus & Not the
primary assessment focus & \textbf{Mostly 1.1} \\
Reading graphs/tables in context & Required & Required &
\textbf{Both} \\
Numerical summaries (mean, median, IQR, spread) & Used for evidence in
investigation & Directly assessed in interpretation questions &
\textbf{Both} \\
Probability, two-way tables, expected value & Limited/indirect &
Directly assessed & \textbf{Mostly 1.3} \\
Justification and statistical reasoning & Required in conclusion and
evaluation & Required in written responses & \textbf{Both} \\
Exam-style interpretation under time pressure & Not the main format &
Core format & \textbf{Mostly 1.3} \\
\end{longtable}

\section{Assessment tags used in this
book}\label{assessment-tags-used-in-this-book}

\begin{itemize}
\tightlist
\item
  \textbf{{[}1.1{]}} mainly assessed in the internal
\item
  \textbf{{[}1.3{]}} mainly assessed in the external
\item
  \textbf{{[}Both{]}} directly useful for both standards
\end{itemize}

\section{Logical learning order and where it is
tested}\label{logical-learning-order-and-where-it-is-tested}

Follow this sequence from start to finish:

\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1296}}
...
\bottomrule\noalign{}
\endlastfoot
1 & Statistical questions, context language, PPDAC foundations & Chapter
1 - What is Statistics? & \textbf{{[}Both{]}} \\
2 & Variables and data types, choosing suitable displays & Chapter 2 -
Data types & \textbf{{[}Both{]}} \\
3 & Graph interpretation and comparison language & Chapter 3 - Graphs &
\textbf{{[}Both{]}} \\
4 & Centre and spread for comparison and conclusions & Chapter 4 -
Measures & \textbf{{[}Both{]}} \\
5 & Probability tools and table-based reasoning & Chapter 5 -
Probability & \textbf{{[}1.3{]}} \\
6 & Sampling quality, bias, inference, critique & Chapter 6 - Inference
& \textbf{{[}Both{]}} \\
7 & Applied tasks and mixed practice with response scaffolds & Chapter 7
- Practice & \textbf{{[}Both{]}} \\
8 & Extension reading and source material & Resource Library &
\textbf{{[}Both{]}} \\
\end{longtable}

\section{How to use this pathway for dual
preparation}\label{how-to-use-this-pathway-for-dual-preparation}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Build investigation capability first (Chapters 1-4) for strong
  \textbf{AS1.1} evidence.
\item
  Add probability and fast interpretation skills (Chapters 5-7) for
  \textbf{AS1.3}.
\item
  In every written response, include context, comparison, and
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{At a Glance: AS1.3 (External)}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Internal/External connection}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0]

If you can explain findings from your own investigation clearly and in
context (AS1.1), you are building the same reasoning needed for
interpretation and justification in AS1.3.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/welcome-plot-1.pdf}}
...
Head to Chapter~\ref{sec-intro} to begin the combined 1.1 + 1.3 pathway.
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key definition}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0]
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{chapters/01-intro_files/figure-pdf/ppdac-diagram-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Answers}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Common mistake}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-warning-color-frame, opacityback=0]
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{chapters/02-data-types_files/figure-pdf/data-types-tree-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Identify the variable types}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-bar-transport-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-dotplot-study-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-histogram-height-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-shape-examples-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-boxplot-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-boxplot-anatomy-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-scatter-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Correlation ≠ Causation}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-warning-color-frame, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/03-graphs_files/figure-pdf/fig-pie-1.pdf}}
...
\chapter{Chapter 4: Bivariate Data in
Ecology}\label{chapter-4-bivariate-data-in-ecology}

Investigating Kōura Habitats using the PPDAC Cycle

\hfill\break

\bookmarksetup{startatroot}

\chapter{Introduction to Bivariate
Data}\label{introduction-to-bivariate-data}

In this chapter, we apply the PPDAC (Problem, Plan, Data, Analysis,
Conclusion) statistical enquiry cycle to a real-world ecological
context. Understanding how two numerical variables interact is a core
component of NCEA Level 1 Statistics.

\section{Exercise: Project Kōura}\label{exercise-project-kux14dura}

\textbf{Context:} A group of students---Jack, Trishav, and Levi---are
conducting a local ecological survey, which they have named ``Project
Kōura''. They are investigating the populations of native freshwater
crayfish (kōura) across several local catchments, including the Kaikorai
Stream and the Water of Leith. They want to know if the physical
environment of the stream affects the growth of the kōura. They have
accessed an open dataset from the New Zealand Freshwater Fish Database
(NZFFD) containing recent survey results.

\subsection{1. Problem}\label{problem}

Before looking at the data, the group needs to define a clear
investigative question. Jack suggests they look at the relationship
between the water temperature of the stream and the size of the kōura.

\textbf{Task A:} Write a suitable investigative question for this
survey. Ensure you specify the variables, the population, and the
direction of your investigation.

\textbf{Task B:} Write a hypothesis. Based on what you know about
freshwater biology, what kind of relationship do you expect to see
between water temperature and kōura carapace length?

\subsection{2. Plan}\label{plan}
...
\tightlist
\item
  \textbf{Explanatory Variable:} Stream Temperature (°C)
\item
  \textbf{Response Variable:} Carapace Length (mm)
\end{itemize}

\textbf{Task C:} Why is Stream Temperature the explanatory variable and
Carapace Length the response variable, rather than the other way around?

\subsection{3. Data}\label{data}

We will simulate importing the NZFFD dataset directly into R to prepare
it for analysis.
...
\CommentTok{\# Simulate importing the NZFFD dataset }
\CommentTok{\# In a real scenario, you would use: read\_csv("koura\_data.csv")}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{koura\_data }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{catchment =} \FunctionTok{sample}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"Water of Leith"}\NormalTok{, }\StringTok{"Kaikorai Stream"}\NormalTok{, }\StringTok{"Taieri River"}\NormalTok{), }\DecValTok{100}\NormalTok{, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{),}
  \AttributeTok{temp\_c =} \FunctionTok{runif}\NormalTok{(}\DecValTok{100}\NormalTok{, }\DecValTok{8}\NormalTok{, }\DecValTok{16}\NormalTok{),}
  \CommentTok{\# Simulating a negative correlation: cooler water tends to support larger kōura}
  \AttributeTok{carapace\_length\_mm =} \DecValTok{60} \SpecialCharTok{{-}}\NormalTok{ (}\FloatTok{1.5} \SpecialCharTok{*}\NormalTok{ temp\_c) }\SpecialCharTok{+} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{mean =} \DecValTok{0}\NormalTok{, }\AttributeTok{sd =} \DecValTok{4}\NormalTok{) }
\NormalTok{)}

\CommentTok{\# Preview the data structure}
\FunctionTok{head}\NormalTok{(koura\_data)}
\CommentTok{\#\textgreater{} \# A tibble: 6 x 3}
\CommentTok{\#\textgreater{}   catchment       temp\_c carapace\_length\_mm}
\CommentTok{\#\textgreater{}   \textless{}chr\textgreater{}            \textless{}dbl\textgreater{}              \textless{}dbl\textgreater{}}
\CommentTok{\#\textgreater{} 1 Taieri River     11.0                37.1}
\CommentTok{\#\textgreater{} 2 Taieri River     15.9                36.0}
\CommentTok{\#\textgreater{} 3 Taieri River      9.23               48.2}
\CommentTok{\#\textgreater{} 4 Kaikorai Stream   8.73               48.1}
\CommentTok{\#\textgreater{} 5 Taieri River      9.14               46.7}
\CommentTok{\#\textgreater{} 6 Kaikorai Stream  13.5                37.2}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/04-measures_files/figure-pdf/fig-mean-vs-median-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Rule of thumb}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/04-measures_files/figure-pdf/fig-compare-boxplot-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/05-probability_files/figure-pdf/fig-prob-scale-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/05-probability_files/figure-pdf/fig-coin-simulation-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Law of Large Numbers}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/05-probability_files/figure-pdf/fig-tree-diagram-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/06-inference_files/figure-pdf/fig-bias-types-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/06-inference_files/figure-pdf/fig-sample-size-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/06-inference_files/figure-pdf/fig-spurious-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/06-inference_files/figure-pdf/fig-misleading-axis-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Be careful with percentages}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{News headline}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{The golden rule}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Worked solutions}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/07-practice_files/figure-pdf/fig-merit-boxplot-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Model answers}, toptitle=1mm, arc=.35mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0]
...
\chapter{Resource Library}\label{resource-library}

This section consolidates the most valuable external resources used
across this book. Each item includes a direct link and its bibliography
citation key.

\section{Assessment And Standard
Documents}\label{assessment-and-standard-documents}

\begin{itemize}
\tightlist
\item
  \href{https://www.nzqa.govt.nz/nqfdocs/ncea-resource/achievements/2024/as91946.pdf}{Achievement
  Standard 91946 (NZQA PDF)} (New Zealand Qualifications Authority
  2024a)
\item
  \href{https://www.nzqa.govt.nz}{NZQA Main Site} (New Zealand
  Qualifications Authority 2024b)
\end{itemize}

\section{New Zealand Curriculum
Resources}\label{new-zealand-curriculum-resources}

\begin{itemize}
\tightlist
\item
  \href{https://nzcurriculum.tki.org.nz}{The New Zealand Curriculum}
  (Ministry of Education New Zealand 2007)
\item
  \href{https://nzcurriculum.tki.org.nz/The-New-Zealand-Curriculum/Mathematics-and-statistics}{Mathematics
  And Statistics Achievement Objectives} (Ministry of Education New
  Zealand 2023)
\end{itemize}

\section{Official Data Sources}\label{official-data-sources}

\begin{itemize}
\tightlist
\item
  \href{https://www.stats.govt.nz}{Stats NZ} (Statistics New Zealand
  2024)
\item
  \href{https://new.censusatschool.org.nz}{CensusAtSchool New Zealand}
  (University of Auckland 2024)
\end{itemize}

\section{Software And Technical
Resources}\label{software-and-technical-resources}

\begin{itemize}
\tightlist
\item
  \href{https://www.r-project.org}{R Project} (R Core Team 2024)
\item
  \href{https://quarto.org}{Quarto} (Allaire et al. 2024)
\item
  \href{https://ggplot2-book.org}{ggplot2 Book} (Wickham, Navarro, and
  Pedersen 2023)
\end{itemize}

\section{Statistical Thinking And Literacy
Texts}\label{statistical-thinking-and-literacy-texts}

\begin{itemize}
\tightlist
\item
  Chance Encounters: A First Course in Data Analysis and Inference (Wild
  and Seber 2000)
\item
  Towards an understanding of statistical thinking (Pfannkuch and Wild
  2004)
\item
...
\section{Citation Notes}\label{citation-notes}

The full bibliographic records for this section are maintained in
\href{../references.bib}{references.bib}.
...
\bibitem[\citeproctext]{ref-quarto-2024}
Allaire, J. J., C. Teague, C. Scheidegger, Y. Xie, and C. Dervieux.
2024. {``Quarto.''} \url{https://quarto.org}.

\bibitem[\citeproctext]{ref-huff-1954}
Huff, Darrell. 1954. \emph{How to Lie with Statistics}. New York: W. W.
Norton \& Company.

\bibitem[\citeproctext]{ref-nz-curriculum-2007}
Ministry of Education New Zealand. 2007. {``The New Zealand
Curriculum.''} Learning Media. \url{https://nzcurriculum.tki.org.nz}.

\bibitem[\citeproctext]{ref-moe-maths-stats-2023}
---------. 2023. {``Mathematics and Statistics - Achievement
Objectives.''}
\url{https://nzcurriculum.tki.org.nz/The-New-Zealand-Curriculum/Mathematics-and-statistics}.

\bibitem[\citeproctext]{ref-nzqa-as91946-pdf}
New Zealand Qualifications Authority. 2024a. {``Achievement Standard
91946 (Official PDF).''} NZQA.
\url{https://www.nzqa.govt.nz/nqfdocs/ncea-resource/achievements/2024/as91946.pdf}.

\bibitem[\citeproctext]{ref-nzqa-as91946}
---------. 2024b. {``Achievement Standard 91946: Interpret and Apply
Mathematical and Statistical Information in Context.''} NZQA.
\url{https://www.nzqa.govt.nz}.

\bibitem[\citeproctext]{ref-pfannkuch-wild-2004}
Pfannkuch, M., and C. J. Wild. 2004. {``Towards an Understanding of
Statistical Thinking.''} In \emph{The Challenge of Developing
Statistical Literacy, Reasoning and Thinking}, edited by D. Ben-Zvi and
J. Garfield, 17--46. Dordrecht: Kluwer Academic.

\bibitem[\citeproctext]{ref-r-core-2024}
R Core Team. 2024. \emph{{R}: A Language and Environment for Statistical
Computing}. Vienna, Austria: R Foundation for Statistical Computing.
\url{https://www.r-project.org}.

\bibitem[\citeproctext]{ref-statsnz-2024}
Statistics New Zealand. 2024. {``Stats NZ --- Official Statistics.''}
\url{https://www.stats.govt.nz}.

\bibitem[\citeproctext]{ref-censusatschool-2024}
University of Auckland. 2024. {``CensusAtSchool New Zealand.''}
\url{https://new.censusatschool.org.nz}.

\bibitem[\citeproctext]{ref-wheelan-2013}
Wheelan, Charles. 2013. \emph{Naked Statistics: Stripping the Dread from
the Data}. New York: W. W. Norton \& Company.

\bibitem[\citeproctext]{ref-wickham-ggplot2-2023}
Wickham, Hadley, Danielle Navarro, and Thomas Lin Pedersen. 2023.
\emph{Ggplot2: Elegant Graphics for Data Analysis}. 3rd ed. Springer.
\url{https://ggplot2-book.org}.

\bibitem[\citeproctext]{ref-wild-seber-2000}
Wild, C. J., and G. A. F. Seber. 2000. \emph{Chance Encounters: A First
