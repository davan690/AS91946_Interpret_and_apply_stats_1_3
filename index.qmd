...
This resource combines the shared teaching for **AS1.1** (statistical
investigation) and **AS1.3 / 91946** (interpret and apply statistical
information). The goal is to make the overlap explicit, reduce duplication,
and show students how the same statistical thinking is used in both standards.
